...
public class ProximityFlashlightActivity extends Activity implements OnTouchListener{
    ...
    {
    	// Put your code here to turn the flashlight
    	// on (as explained in the lab writeup).
    }
    ...
    {
    	// Put your code here to turn the flashlight
    	// off (as explained in the lab writeup).
    }
    ...
    {
    	// Put your code here to check if the MotionEvent is from the user touching
    	// down on the screen (as explained in the lab writeup).
